...
(1) Use GitHub's Codespaces (which links to a virtual computer with VS Code + Lean already installed).  Click the "Code" button, choose "Codespaces" and then "Create codespace on main" 
